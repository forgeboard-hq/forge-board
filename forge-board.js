...
/* ---------------- username list for the dice ---------------- */
  const USERNAMES = [
  "broken vessel", "empty vessel", "mended vessel", "simple vessel",
  "little child", "glad child", "joyful child", "beloved child",
  "adopted child", "tired pilgrim", "weary pilgrim", "quiet pilgrim",
  "lone pilgrim", "glad pilgrim", "bold pilgrim", "weary soul",
  "grateful soul", "restless soul", "seeking soul", "hungry soul",
  "thirsty soul", "tender soul", "gentle soul", "quiet soul",
  "willing soul", "kindred soul", "lone soul", "singing soul",
  "faithful soul", "redeemed soul", "rescued soul", "ransomed soul",
  "forgiven soul", "healed soul", "restored soul", "renewed soul",
  "mended soul", "quiet heart", "calm heart", "kind heart",
  "open heart", "tender heart", "gentle heart", "warm heart",
  "soft heart", "loving heart", "loyal heart", "glad heart",
  "joyful heart", "willing heart", "seeking heart", "hungry heart",
  "devoted heart", "singing heart", "brave heart", "steady heart",
  "new heart", "healed heart", "mended heart", "renewed heart",
  "glad faith", "simple faith", "quiet faith", "daily faith",
  "new faith", "joyful faith", "growing faith", "tested faith",
  "tried faith", "raw faith", "living faith", "brave faith",
  "sure hope", "quiet hope", "steady hope", "patient hope",
  "daily hope", "bright hope", "rising hope", "living hope",
  "new hope", "joyful hope", "bold hope", "pure joy",
  "inner joy", "bright joy", "deep joy", "simple joy",
  "lasting joy", "dancing joy", "true joy", "daily joy",
  "new joy", "singing joy", "inner peace", "quiet peace",
  "calm peace", "gentle peace", "deep peace", "full peace",
  "real peace", "sure peace", "sweet peace", "still peace",
  "steady peace", "lasting peace", "pure peace", "free life",
  "daily life", "full life", "new life", "whole life",
  "bright life", "changed life", "restored life", "renewed life",
  "hidden light", "soft light", "warm light", "gentle light",
  "inner light", "quiet light", "rising light", "little light",
  "glad light", "bright light", "steady light", "new light",
  "flawed saint", "weary saint", "quiet saint", "simple saint",
  "glad saint", "joyful saint", "bold saint", "glad believer",
  "new believer", "joint heir", "adopted heir", "beloved heir",
  "new creation", "living stone", "living soul", "glad servant",
  "kind servant", "true servant", "bold servant", "meek servant",
  "lowly servant", "loyal servant", "quiet servant", "ready servant",
  "weary servant", "tired servant", "young servant", "new servant",
  "good servant", "happy servant", "eager servant", "glad steward",
  "kind steward", "true steward", "good steward", "loyal steward",
  "quiet steward", "ready steward", "wise steward", "new steward",
  "happy steward", "weary steward", "young steward", "eager steward",
  "kind shepherd", "lone shepherd", "true shepherd", "glad shepherd",
  "meek shepherd", "bold shepherd", "lone watchman", "true watchman",
  "kind watchman", "glad watchman", "bold watchman", "kind teacher",
  "glad teacher", "quiet teacher", "ready teacher", "warm teacher",
  "bold teacher", "true teacher", "loyal teacher", "lone teacher",
  "young teacher", "wise teacher", "glad builder", "kind builder",
  "quiet builder", "ready builder", "good builder", "wise builder",
  "bold builder", "loyal builder", "true builder", "lone builder",
  "young builder", "eager builder", "happy builder", "quiet leader",
  "gentle leader", "steady leader", "lowly leader", "loyal leader",
  "weary leader", "tender leader", "bold leader", "tired leader",
  "kind leader", "caring leader", "glad leader", "true leader",
  "young leader", "ready leader", "honest leader", "kind pastor",
  "gentle pastor", "weary pastor", "tired pastor", "quiet pastor",
  "tender pastor", "lowly pastor", "glad pastor", "caring pastor",
  "loving pastor", "steady pastor", "young pastor", "true pastor",
  "loyal pastor", "quiet elder", "gentle elder", "weary elder",
  "tender elder", "patient elder", "honest elder", "steady elder",
  "lowly elder", "praying elder", "wise elder", "glad elder",
  "kind elder", "devoted elder", "loyal elder", "ready elder",
  "true elder", "caring elder", "glad deacon", "kind deacon",
  "quiet deacon", "ready deacon", "loyal deacon", "joyful deacon",
  "lowly deacon", "weary deacon", "true deacon", "young deacon",
  "caring deacon", "gentle deacon", "tender deacon", "tired deacon",
  "glad minister", "kind minister", "true minister", "lone minister",
  "bold minister", "new minister", "glad preacher", "bold preacher",
  "kind preacher", "lone preacher", "true preacher", "new preacher",
  "glad disciple", "true disciple", "lone disciple", "bold disciple",
  "kind disciple", "new disciple", "glad follower", "true follower",
  "lone follower", "bold follower", "kind follower", "new follower",
  "glad worker", "quiet worker", "ready worker", "joyful worker",
  "steady worker", "weary worker", "loyal worker", "kind worker",
  "new worker", "happy worker", "tired worker", "eager worker",
  "gentle worker", "lowly worker", "glad laborer", "weary laborer",
  "quiet laborer", "ready laborer", "loyal laborer", "tired laborer",
  "lone laborer", "young laborer", "glad helper", "ready helper",
  "quiet helper", "kind helper", "joyful helper", "loyal helper",
  "gentle helper", "eager helper", "happy helper", "weary helper",
  "loving helper", "tender helper", "lowly helper", "steady helper",
  "glad giver", "joyful giver", "ready giver", "willing giver",
  "quiet giver", "kind giver", "loyal giver", "merry giver",
  "eager giver", "happy giver", "loving giver", "gentle giver",
  "glad singer", "joyful singer", "quiet singer", "merry singer",
  "happy singer", "lively singer", "sweet singer", "tender singer",
  "gentle singer", "bold witness", "true witness", "glad witness",
  "quiet witness", "ready witness", "brave witness", "lone witness",
  "kind witness", "loyal witness", "glad seeker", "quiet seeker",
  "eager seeker", "weary seeker", "lone seeker", "ready seeker",
  "joyful seeker", "hungry seeker", "glad keeper", "quiet keeper",
  "loyal keeper", "steady keeper", "gentle keeper", "ready keeper",
  "kind keeper", "weary keeper", "lowly keeper", "true friend",
  "kind friend", "loyal friend", "gentle friend", "glad friend",
  "dear friend", "close friend", "tender friend", "steady friend",
  "warm friend", "good friend", "quiet friend", "caring friend",
  "loving friend", "trusty friend", "good neighbor", "kind neighbor",
  "saved sinner", "frail sinner", "weak sinner", "lost sinner",
  "freed sinner", "bold believer", "lone believer", "kind believer",
  "happy pilgrim", "lowly pilgrim", "ready pilgrim", "young pilgrim",
  "kind pilgrim", "loyal pilgrim", "brave pilgrim", "true pilgrim",
  "glad heir", "young heir", "grateful heir", "fellow heir",
  "ready vessel", "lowly vessel", "frail vessel", "plain vessel",
  "small vessel", "common vessel", "weak vessel", "happy child",
  "rescued child", "wayward child", "weary child", "gentle child",
  "yielded child", "loved child", "lowly saint", "broken saint",
  "hidden saint", "young saint", "praying saint", "willing saint",
  "gentle saint", "patient saint", "loyal saint", "ready saint",
  "happy saint", "common saint", "plain saint", "tired saint",
  "bold faith", "calm faith", "small faith", "young faith",
  "fresh faith", "honest faith", "steady faith", "patient faith",
  "lively faith", "small hope", "warm hope", "calm hope",
  "fresh hope", "sweet hope", "gentle hope", "lasting hope",
  "settled hope", "eager hope", "glad hope", "warm joy",
  "calm joy", "sweet joy", "soft joy", "still joy",
  "gentle joy", "morning joy", "endless joy", "quiet joy",
  "living joy", "warm peace", "soft peace", "settled peace",
  "simple peace", "living peace", "hidden peace", "daily peace",
  "new peace", "simple life", "quiet life", "useful life",
  "given life", "yielded life", "ransomed life", "redeemed life",
  "fruitful life", "hidden life", "healed life", "mended life",
  "settled life", "small light", "kindly light", "morning light",
  "shining light", "lowly light", "simple light", "glowing light",
  "calm light", "daily light", "fellow saint", "fellow worker",
];
